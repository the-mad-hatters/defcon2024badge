...
const TProgmemPalette16 secret_combinations_p PROGMEM = {
    CRGB::GreenYellow, CRGB::Black, CRGB::Red, CRGB::Red,
    CRGB::Black, CRGB::Black, CRGB::GreenYellow, CRGB::Black,
...
const TProgmemPalette16 secret_combinations_main_p PROGMEM = {
    CRGB::GreenYellow, CRGB::Black, CRGB::Black, CRGB::GreenYellow,
    CRGB::Black, CRGB::Black, CRGB::GreenYellow, CRGB::Black,
    CRGB::Black, CRGB::GreenYellow, CRGB::Black, CRGB::Black,
    CRGB::GreenYellow, CRGB::Black, CRGB::Black, CRGB::Black
...
const TProgmemPalette16 gone_clear_p PROGMEM = {
    CRGB::WhiteSmoke, CRGB::Black, CRGB::Black, CRGB::WhiteSmoke,
...
const TProgmemPalette16 gone_clear_main_p PROGMEM = {
    CRGB::WhiteSmoke, CRGB::Black, CRGB::Black, CRGB::Orange,
    CRGB::Black, CRGB::Black, CRGB::WhiteSmoke, CRGB::Black,
    CRGB::Black, CRGB::Orange, CRGB::Black, CRGB::Black,
    CRGB::WhiteSmoke, CRGB::Black, CRGB::Black, CRGB::Black
