...
const TProgmemPalette16 mad_hatter_p PROGMEM = {
    CRGB::DarkOrange, CRGB::Black, CRGB::DarkOrange, CRGB::Black,
    CRGB::GreenYellow, CRGB::Black, CRGB::GreenYellow, CRGB::Black,
...
const TProgmemPalette16 mad_hatter_main_p PROGMEM = {
    ...
    CRGB::GreenYellow, CRGB::Black, CRGB::GreenYellow, CRGB::Black,
    CRGB::Green, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::Blue, CRGB::Black, CRGB::Blue, CRGB::Black
...
const TProgmemPalette16 celestial_clouds_p PROGMEM = {
    CRGB::Navy, CRGB::Black, CRGB::Navy, CRGB::Black,
...
const TProgmemPalette16 celestial_clouds_main_p PROGMEM = {
    CRGB::Navy, CRGB::Black, CRGB::Red, CRGB::Black,
...
const TProgmemPalette16 gone_to_hell_main_p PROGMEM = {
    CRGB::Maroon, CRGB::Black, CRGB::Maroon, CRGB::Black,
...
const TProgmemPalette16 secret_combinations_p PROGMEM = {
    CRGB::Gold, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::GreenYellow, CRGB::Black, CRGB::GreenYellow, CRGB::Black,
    CRGB::Gold, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::GreenYellow, CRGB::Black, CRGB::GreenYellow, CRGB::Black
...
const TProgmemPalette16 secret_combinations_main_p PROGMEM = {
    CRGB::Gold, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::GreenYellow, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::Gold, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::GreenYellow, CRGB::Black, CRGB::Red, CRGB::Black
...
const TProgmemPalette16 the_salamander_p PROGMEM = {
    CRGB::Chartreuse, CRGB::Black, CRGB::DarkGreen, CRGB::Black,
    CRGB::DarkGreen, CRGB::Black, CRGB::OliveDrab, CRGB::Black,
    CRGB::ForestGreen, CRGB::Black, CRGB::DarkGreen, CRGB::Black,
    CRGB::LawnGreen, CRGB::Black, CRGB::OliveDrab, CRGB::Black
    
};

const TProgmemPalette16 the_salamander_main_p PROGMEM = {
    CRGB::Chartreuse, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::DarkGreen, CRGB::Black, CRGB::OliveDrab, CRGB::Black,
    CRGB::ForestGreen, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::LawnGreen, CRGB::Black, CRGB::OliveDrab, CRGB::Black
...
const TProgmemPalette16 seer_stones_main_p PROGMEM = {
    CRGB::Indigo, CRGB::Black, CRGB::Yellow, CRGB::Black,
...
const TProgmemPalette16 drunk_as_hell_p PROGMEM = {
    CRGB::Blue, CRGB::Black, CRGB::DarkMagenta, CRGB::Black,
    CRGB::Gold, CRGB::Black, CRGB::LawnGreen, CRGB::Black,
    CRGB::OrangeRed, CRGB::Black, CRGB::Yellow, CRGB::Black,
...
const TProgmemPalette16 dc32_y2k_aesthetic_p PROGMEM = {
    CRGB::DarkOrange, CRGB::Black, CRGB::Red, CRGB::Black,
    CRGB::Teal, CRGB::Black, CRGB::DarkOrange, CRGB::Black,
    CRGB::DarkSlateBlue, CRGB::Black, CRGB::DeepPink, CRGB::Black,
